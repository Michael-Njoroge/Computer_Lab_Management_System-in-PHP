...
<?php include('session.php'); ?>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<div class="span9" id="content">
                     <div class="row-fluid">					 
					 <h2 id="sc" align="center"><image src="imglogo.png" width="45%" height="45%"/></h2>
				<?php	
 ...
 <br/>
	<div class="pull-left">
			...
			<?php	
	           $count_item1=mysqli_query($conn,"select * from tbldevice 
			   LEFT JOIN tbldevice_name ON tbldevice.dev_id=tbldevice_name.dev_id
			   where 
			   ...
			   ORDER BY tbldevice.id DESC");
 	           $count = mysqli_num_rows($count_item1);
               ?>
				<li class="">
			 ...
			 <?php	
	           $count_item2=mysqli_query($conn,"select * from tbldevice 
			   LEFT JOIN tbldevice_name ON tbldevice.dev_id=tbldevice_name.dev_id
	           ...
	           $count = mysqli_num_rows($count_item2);
               ?>
				<li class="">
			 ...
			 <?php	
	           $count_item3=mysqli_query($conn,"select * from tbldevice 
			   LEFT JOIN tbldevice_name ON tbldevice.dev_id=tbldevice_name.dev_id
	           ...
	           $count = mysqli_num_rows($count_item3);
               ?>
				<li class="">
			 ...
			 <?php	
	           $count_item4=mysqli_query($conn,"select * from tbldevice 
			   LEFT JOIN tbldevice_name ON tbldevice.dev_id=tbldevice_name.dev_id
	           ...
	           $count = mysqli_num_rows($count_item4);
               ?>
				<li class="">
				...
				<?php	
	           $count_item5=mysqli_query($conn,"select * from tbldevice 
			   LEFT JOIN tbldevice_name ON tbldevice.dev_id=tbldevice_name.dev_id
	           ...
	           $count = mysqli_num_rows($count_item5);
               ?>
				<li class="">
               ...
               ?>
				...
				<?php	
	           $count_item6=mysqli_query($conn,"select * from tbldevice 
			   LEFT JOIN tbldevice_name ON tbldevice.dev_id=tbldevice_name.dev_id
			   where 
			...
			OR dev_status = 'damage' and dev_name = 'automtic Voltge Reactor'      OR dev_status = 'damage'     and dev_name = 'automtic Voltge Regulator'
	           ...
	           $count = mysqli_num_rows($count_item6);
               ?>
				<li class="">
...
$dev_status = $row['dev_status'];
		...
		<td class="empty">
			...
			<td><?php
			   $device_query1 = mysqli_query($conn,"select * from tbldevice ");
