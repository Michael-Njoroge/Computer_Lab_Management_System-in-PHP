	 ...
	 <img id="admin_avatar" class="img-polaroid" src="img/logo.png">
                  ...
                  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                           <li class="active"> 
						   <a href="home.php"><i class="icon-chevron-right"></i><i class="icon-home"></i>&nbsp;Dashboard</a> 
						   </li>
					  ...
					  <!------/.* manage TRIS user sidebar*------->	
						<li>						
                            ...
                            <li class="">
                            <a href="client_user.php"><i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Lab Technician Staff</a>
                            </li>
						    <li class="">
