...
<?php 
mysqli_query($conn,"update tbldevice set dev_status='Dump' where id = '$get_id'")or die(mysqli_error($conn));
mysqli_query($conn,"insert into tblactivity_log (date,username,action) values(NOW(),'$admin_username','Dump Device $dev_name Inventory Code:$dev_serial')")or die(mysqli_error($conn));						
