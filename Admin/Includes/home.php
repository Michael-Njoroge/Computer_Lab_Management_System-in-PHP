      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Department Chair Dashboard</h1>
            <ol class="breadcrumb">
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                     <a href="createStudents.php"> <i class="fas fa-users fa-2x text-info"></i></a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Labs</div>
                    ...
                    <div class="col-auto">
                      <a href="createClass.php"><i class="fas fa-chalkboard fa-2x text-primary"></i></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Lab Types</div>
                    ...
                    <div class="col-auto">
                      <a href="createClassArms.php"><i class="fas fa-code-branch fa-2x text-success"></i></a>
                    </div>
                  </div>
                </div>
              </div>
                          ...
                          <div class="card h-100">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                ...
                                <div class="col-auto">
                                  <a href="createClassTeacher.php"><i class="fas fa-chalkboard-teacher fa-2x text-danger"></i></a>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="card h-100">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                ...
                                <div class="col-auto">
                                  <a href="createSessionTerm.php"><i class="fas fa-calendar-alt fa-2x text-warning"></i></a>
                                </div>
                              </div>
                            </div>
                          </div>
