    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_log="select * from tblactivity_log";
				 $result= mysqli_query($conn,$count_log);
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_log.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
                              		...
                              		<?php
										$query = "select * from  tblactivity_log 
										LEFT JOIN tbladmin ON tblactivity_log.username = tbladmin.emailAddress
										order by date DESC";
                                    ...
                                    <tr>
					                    <td width="70">
										 ...
										 <td><img id="avatar1" src="images/NO-IMAGE-AVAILABLE.jpg">&nbsp;
