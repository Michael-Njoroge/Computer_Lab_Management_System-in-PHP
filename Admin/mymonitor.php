        ...
        <!-------------------------------block ------------------------------>
            <div id="block_bg" class="block">
                  <div class="navbar navbar-inner block-header">							
							  <div class="muted pull-left"><i class="icon-building"></i>  <?php 
							 if (null !== $location_row && isset($location_row['stdev_location_name'])) {
             ...
             (select * from tbllocation_details where dev_status='Dump')
			  ...
			  <?php	
               ...
               ?>
				...
				<?php	
	            $my_power_code =mysqli_query($conn, "select * from tbllocation_details    
	            LEFT JOIN tbldevice ON tbllocation_details.tbldevice_id = tbldevice.id
				LEFT JOIN tbldevice_name ON tbldevice.dev_id=tbldevice_name.dev_id
				where NOT EXISTS 
                (select * from tbllocation_details where dev_status='Dump') 
			    ...
			    $count = mysqli_num_rows($my_power_code);
               ?>				
				<li class="">			
...
<tr>
		<td><?php
			   $device_query2 = mysqli_query($conn,"select * from tbldevice ");
			...
			<td><?php
			   $my_device1 = "select * from tbldevice ";
			   $result= mysqli_query($conn,$my_device1);
			...
			<a rel="tooltip"  title="Update Status" id="t<?php echo $id; ?>" href="devlmtr_update_status.php<?php echo '?id='.$id; ?>&<?php echo 'tbldevice_id='.$get_id; ?>" class="btn btn-success"><i class="icon-upload-alt"></i> Status</a></td>
		</tr>
