	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
								$query = "select * from tbladmin where admin_id = '$get_id'";
								...
								<form method="post">
										...
										<div class="control-group">
                                          <div class="controls">
											...
											<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" value="<?php echo $row['emailAddress']; ?>"  name="username" id="focusedInput" type="text" placeholder = "Username" required>
                                          </div>
                                        </div>
...
$update="update tbladmin set emailAddress = '$username'  , firstName = '$firstname' , lastName = '$lastname' where admin_id = '$get_id' ";
$result= mysqli_query($conn,$update);

$insert="insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit system User $firstname')";	
