            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
                        <!-- block -->
						<?php	
	                 $count_log=mysqli_query($conn,"select * from tbluser_log");
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_user_log.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$user_query = mysqli_query($conn,"select * from tbluser_log order by login_date AND logout_date DESC")or die(mysqli_error($conn));
