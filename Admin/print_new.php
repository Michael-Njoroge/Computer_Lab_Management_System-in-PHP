  ...
  <div class="row-fluid">
      <div class="col-lg-12">
            <div class="alert alert-danger alert-dismissable">
             ...
             <i class="icon-remove"></i><strong> New Device Print Report</strong>
            </div>
       </div>
    </div>
  </div>
...
<?php
	   ...
	   (select * from tbllocation_details where tbldevice.id = tbllocation_details.tbldevice_id)
		and dev_status='new' ORDER BY tbldevice.id DESC")or die(mysqli_error($conn));
...
?>	
 ...
 <?php
$new = mysqli_query($conn,"select * from tbldevice
		LEFT JOIN tbldevice_name ON tbldevice.dev_id=tbldevice_name.dev_id
		where NOT EXISTS 
	   (select * from tbllocation_details where tbldevice.id = tbllocation_details.tbldevice_id)
		and dev_status='new' ORDER BY tbldevice.id DESC")or die(mysqli_error($conn));
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <?php $query= mysqli_query($conn,"select * from tbladmin where admin_id = '$session_id'") or die(mysqli_error($conn));
