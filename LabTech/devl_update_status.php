...
<?php $stdev_id = $_GET['tbldevice_id']; ?>
<?php $get_id = $_GET['id']; ?>
    <body>
									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
									   ...
									   <div class="control-group">
										...
										mysqli_query($conn,"update tbldevice set 
										            dev_id = '$dev_id',																		
													dev_status = '$dev_status'
													where id = '$get_id' ")or die(mysqli_error($conn));
													
										mysqli_query($conn,"insert into tblactivity_log (date,username,action) values(NOW(),'$admin_username','Update Status $dev_name to $dev_status ')")or die(mysqli_error($conn));			
										?>
										<script>
