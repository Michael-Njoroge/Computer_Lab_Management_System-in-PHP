...
<tr>
		<td><?php
			...
			<a rel="tooltip"  title="Update Status" id="t<?php echo $id; ?>" href="devlk_update_status.php<?php echo '?id='.$id; ?>&<?php echo 'tbldevice_id='.$get_id; ?>" class="btn btn-success"><i class="icon-upload-alt"></i> Status</a></td>
		</tr>
