  ...
  <div class="row-fluid">
      <div class="col-lg-12">
            <div class="alert alert-danger alert-dismissable">
             ...
             <i class="icon-remove"></i><strong> Damage CPU Print Report</strong>
            </div>
       </div>
    </div>
  </div>
...
"Times New Roman","serif"'>Damaged CPU:<o:p></o:p></span></p>
...
<div class="pull-right">
   <div class="empty">
		   ...
		   <script type="text/javascript">
            ...
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
			<a id="return" data-placement="top" class="btn btn-success" title="Click to Return" href="damage_cpu.php"><i class="icon-arrow-left"></i> Back</a></p>		
			<script type="text/javascript">
			$(document).ready(function(){
			$('#return').tooltip('show');
			$('#return').tooltip('hide');
...
<?php
		$device_query = "select * from tbldevice			
							 ...
							 where dev_name = 'cpu' and dev_status= 'damage' ORDER BY tbllocation_details.ld_id DESC";
